...
import { LayoutDashboard, CreditCard, BarChart3, Settings, LogOut, ShieldCheck, FileText, Plus, Camera, Receipt, Upload, HelpCircle, Bot } from "lucide-react"
                ...
                <div className="flex-1 overflow-auto py-2">
                    <nav className="grid items-start px-2 text-sm font-medium lg:px-4 gap-1">
                        ...
                        <Link
                            ...
                            className={cn(
                                "flex items-center gap-3 rounded-lg px-3 py-2 transition-all hover:text-primary",
                                pathname.startsWith('/debts') ? "bg-muted text-primary" : "text-muted-foreground"
                            )}
                        >
                        ...
                        <Link
                            ...
                            className={cn(
                                "flex items-center gap-3 rounded-lg px-3 py-2 transition-all hover:text-primary",
                                pathname.startsWith('/coach') ? "bg-muted text-primary" : "text-muted-foreground"
                            )}
                        >
